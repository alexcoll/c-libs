...
//
void llist_add(LinkedList * list, double value) {
	// Create new node
...
//
int llist_exists(LinkedList * list, double value) {
	ListNode * e;
...
//
int llist_remove(LinkedList * list, double value) {
	ListNode * e;
	ListNode * previous;
...
//
int llist_get_ith(LinkedList * list, double ith, double * value) {
	ListNode * e;
...
// It returns 1 if success or 0 if there is no ith entry.
//
int llist_remove_ith(LinkedList * list, double ith) {
	ListNode * e;
...
//
void llist_sort(LinkedList * list, double ascending) {
	// FIXME
	ListNode * e;
	double done = 0.0;
	if (list->head == NULL) {
...
//
int llist_remove_first(LinkedList * list, double * value) {
	if (list->head == NULL) {
		return 0;
	}
...
//
int llist_remove_last(LinkedList * list, double *value) {
  	ListNode * e;
...
//
void llist_insert_first(LinkedList * list, double value) {
	ListNode * n = (ListNode *) malloc(sizeof(ListNode));
	n->value = value;
	n->next = list->head;
	list->head = n;
...
//
void llist_insert_last(LinkedList * list, double value) {
	ListNode * e;
